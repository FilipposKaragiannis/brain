...
- **Negative Space** — what a skill leaves unaddressed isn't neutral; it's delegated to the agent's priors. Read a draft for its silences and decide each one on purpose — fill it in, or leave it open as a real **branch** — instead of by accident.
