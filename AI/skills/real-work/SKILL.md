...
**Verification Plan** and record the result before moving on. If a phase changed behaviour
or structure in an area that carries living documentation, update that documentation as part
of the phase — don't defer it to the recap. When all phases are
